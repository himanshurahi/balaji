										...
										<div class="footer__widget">
											...
											<div class="footer__widget-content">
												<p class="footer-text mb-35">
													Our mission statement is to provide the absolute best customer experience
													available in the Electronic industry without exception.
												</p>
												...
												<div class="footer__info">
													<ul>
														<li>
															<span
																>Add:
																<a target="_blank" href="https://goo.gl/maps/c82DDZ8ALvL878Bv8"
							...
							<div class="col-xl-12">
								...
								<div class="copy-right-area text-center">
									<p>
										...
										<a href="#"><span class="main-color">Theme_Pure.</span></a>
									</p>
								</div>
							</div>
						</div>
